...
# Note: This is not Silica's repository. This is my jailbreak repo template, so I can generate my repo using silica. If you're looking for Silica, go to [https://github.com/Shugabuga/Silica](https://github.com/Shugabuga/Silica)
